...
Response::Response(const unsigned int fd, const std::string &root_path) : _fd(fd), _root_path(root_path)
{
	this->InsertHeaderKey();
	std::cout << "Response object created argument" << std::endl;
}
...
void Reaponse::HandleGet(Request& req)
{
	ReadFile();
	return (StatusMessage::OK())
}

void Reaponse::HandleMethod(Request& req)
{
...
void Reaponse::ExecuteResponse(Response& req)
{
